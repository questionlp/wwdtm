...
**Note:** The authoritative version of this repository now resides on Codeberg
as `wwdtm`_ and mirrors changes to GitHub. Going forward, issues and pull
requests should be created on Codeberg rather than GitHub.

.. _wwdtm: https://codeberg.org/qlp/wwdtm/
...
This project does not use any form of AI for its development or testing process;
neither does the project accept code that is (partially or wholly) generated by
AI, even if it is fully disclosed.
