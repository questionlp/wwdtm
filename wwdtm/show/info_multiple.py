...
class ShowInfoMultiple:
    ...
    def retrieve_bluff_info_all(self,
    ...
    def retrieve_bluff_info_by_ids(self,
                                   show_ids: List[int]
                                   ) -> Dict[int, List[Dict[str, Any]]]:
        """Returns a dictionary containing Bluff the Listener information
    ...
    def retrieve_core_info_all(self,
                               exclude_null_dates: bool = False
    ...
    def retrieve_core_info_by_ids(self,
                                  show_ids: List[int]
                                  ) -> Dict[int, Dict[str, Any]]:
    ...
    def retrieve_guest_info_all(self,
                                exclude_null_dates: bool = False
                                ) -> Dict[int, List[Dict[str, Any]]]:
    ...
    def retrieve_guest_info_by_ids(self,
                                   show_ids: List[int]
                                   ) -> Dict[int, List[Dict[str, Any]]]:
        """Returns a list of dictionary objects containing Not My Job
    ...
    def retrieve_panelist_info_all(self,
                                   exclude_null_dates: bool = False
                                   ) -> Dict[int, List[Dict[str, Any]]]:
    ...
    def retrieve_panelist_info_by_ids(self,
                                      show_ids: List[int]
                                      ) -> Dict[int, List[Dict[str, Any]]]:
        """Returns a list of dictionary objects containing panelist
